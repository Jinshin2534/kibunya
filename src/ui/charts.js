import { normalize, polylinePoints } from '../lib/chartData.js'
...
// normalize 本体は src/lib/chartData.js（純粋関数・テスト済み）にある。
// ここでは brief の interface どおり ui/charts.js からも呼べるよう re-export する。
export { normalize }
